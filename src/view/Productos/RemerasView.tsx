...
export default function RemerasView() {
  // 1. INICIALIZAR FILTROS CON LA CATEGORÍA 'REMERAS'
  const [filters, setFilters] = useState<FilterState>({
    category: "remeras", // <--- ¡AQUÍ ESTÁ EL CAMBIO CLAVE!
    size: "",
    minPrice: 0,
    maxPrice: 999999,
    sort: "",
  ...
  const updateFilters = (newFilters: Partial<FilterState>) => {
    setFilters((prev) => ({
      ...prev,
      ...newFilters,
      // Siempre forzamos la categoría a "Remeras" en esta vista
      category: "remeras",
    }));
  };
  ...
  return (
    <div className="flex w-full min-h-screen px-4 lg:px-10 py-10 gap-12 mt-20">
      <h1 className="sr-only">Explorar Remeras</h1>
